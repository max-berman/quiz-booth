...
export default function CompleteSignIn() {
  ...
  const handleCompleteSignIn = async (emailToUse: string) => {
    ...
    try {
      ...
      setError('Failed to complete sign-in. Please try again or request a new link.');
      toast({
    ...
    return (
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-md mx-auto px-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-center text-green-600">Sign-in Successful!</CardTitle>
            </CardHeader>
    ...
    return (
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-md mx-auto px-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-center text-red-600">Sign-in Error</CardTitle>
            </CardHeader>
            <CardContent className="text-center space-y-4">
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-center text-gray-600 text-sm">
              {email ? 'Completing sign-in...' : 'Enter your email to complete sign-in'}
            </p>
          </CardHeader>
          <CardContent>
            {isCompleting ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    This should be the same email where you received the sign-in link.
                  </p>
                </div>
