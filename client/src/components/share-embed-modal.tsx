...
export function ShareEmbedModal({ gameId, gameTitle, isBuilder = false }: ShareEmbedModalProps) {
  ...
  const handleShare = async () => {
    const shareData = {
      title: isBuilder ? "Trade Show Trivia Builder" : `${gameTitle} Trivia Challenge`,
      text: isBuilder 
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button variant="outline" className="px-4 py-2">
          ...
          {isBuilder ? "Share Builder" : "Share & Embed"}
        </Button>
      </DialogTrigger>
