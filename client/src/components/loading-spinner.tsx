  ...
  return (
    <div className="max-w-2xl mx-auto text-center">
      <div className="bg-card rounded-2xl shadow-xl p-12">
        ...
        <h3 className="text-2xl font-bold text-foreground mb-4">{message}</h3>
        <p className="text-muted-foreground mb-4">Our AI is creating custom questions based on your company information...</p>
