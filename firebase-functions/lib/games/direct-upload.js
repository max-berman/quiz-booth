...
exports.directImageUpload = void 0;
 ...
 */
exports.directImageUpload = functions.https.onRequest(async (req, res) => {
    // Set CORS headers
        ...
        busboy.on('finish', async () => {
            try {
                ...
                try {
                    ...
                    if (isEmulator && uploadError.code === 'EPROTO') {
                        ...
                        emulatorBucket.storage.customEndpoint = 'http://localhost:9199';
                        emulatorBucket.storage.apiEndpoint = 'http://localhost:9199';
